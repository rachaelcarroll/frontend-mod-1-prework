...
var email = {
  ...
  dateReceived: new Date(2021, 1, 14)
};
...
var email = [
{
  senderEmail: "coolboss@gmail.com",
  opened: true,
  hasAttachment: false,
  subject: "Job Interview",
  dateReceived: new Date(2021, 1, 14)
...
{
  senderEmail: "ashleyk@gmail.com",
  opened: false,
  hasAttachment: true,
  subject: "Holiday Party Details",
  dateReceived: new Date(2020, 11, 20)
},
{
  senderEmail: "jillc123@gmail.com",
  opened: true,
  hasAttachment: false,
  subject: "Just saying hi...",
  dateReceived: new Date(2021, 0, 5)
}
]
