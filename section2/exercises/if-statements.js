...
for yourself!
I used the logical operator && for the last exercise about pizza but not with the
exercise about gumballs. I went back to see if using one would simplify the conditional
