...
// The console will use interpolation and log line 22 as a string of data since the sentence is in ``
...
// Declare three variables, name/content/data type of your choice. Think carefully about what
  ...
  console.log(`The restaurant's ${dessert} is #${ranking} in ${city}!`)
